...
class KoradSerial(object):
    ...
    class Serial(object):
        ...
        def __init__(self, port,debug=False, **kwargs):
            ...
            self.debug = debug
            self.port = serial.Serial(port,kwargs['baudrate'],timeout=kwargs['timeout'],parity=kwargs['parity'],rtscts=kwargs['rtscts'])
    ...
    def __init__(self, port, debug=False, **kwargs):
        ...
        self.__serial = KoradSerial.Serial(port=port, debug=debug, **kwargs)
